                    ...
                    <div class="card">
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <h6 class="text-muted font-semibold">Record EDOM</h6>
                                    <h6 class="font-extrabold mb-0">{{ $quesioner_edom }}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <h6 class="text-muted font-semibold">Record Fasilitas</h6>
                                    <h6 class="font-extrabold mb-0">{{ $quesioner_fas }}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body py-4 px-5">
                    <div class="d-flex align-items-center">
                        <div class="avatar avatar-xl">
                            <img src="{{asset('theme/dist/assets/images/faces/1.jpg')}}" alt="Face 1">
                        </div>
                        <div class="ms-3 name">
                            <h5 class="font-bold">
                                @auth
                ...
                <div class="footer clearfix mb-0 text-muted">
                    ...
                    <div class="float-end">
                        <p>Crafted<span class="text-danger"></span> by <a
                                href="http://ahmadsaugi.com">Nurul Huda</a></p>
                    </div>
                </div>
            </footer>
        </div>
