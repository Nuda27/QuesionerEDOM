        ...
        <div id="auth-left">
            ...
            <form action="/login" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group position-relative has-icon-left mb-4">
                    <input type="text" class="form-control form-control-xl" name="email" value="{{ old('email') }}" placeholder="Username" required>
            ...
            <div class="text-center mt-5 text-lg fs-4">
                <p class="text-gray-600">Kamu Mahasiswa? Isi Quesioner <a href="/guest" class="font-bold">Disini</a>.</p>
